...
class LoraInterferenceHelper
{
  public:
    ...
    /**
     * Interference model used to decide packet destruction.
     */
    ...
    /**
     * Set default probabilistic capture parameters for all instances.
     *
     * This is used to configure helpers created as value members.
     */
    static void SetProbabilisticCaptureDefaults(bool enable,
                                                double slope,
                                                double minProb,
                                                double maxProb);

    /**
     * Set default interference model parameters for all instances.
     *
     * This is used to configure helpers created as value members.
     */
    static void SetInterferenceModelDefaults(InterferenceModel model,
  ...
  private:
    ...
    bool m_enableProbabilisticCapture; //!< Enable probabilistic capture for cross-SF collisions
    double m_captureSlope;             //!< Logistic slope for capture probability
    double m_captureMinProb;           //!< Minimum success probability
    double m_captureMaxProb;           //!< Maximum success probability
    InterferenceModel m_interferenceModel; //!< Interference model selector
    double m_puelloCaptureThresholdDb; //!< Capture threshold [dB] for Pueyo/Puello model
    double m_puelloAssumedBandwidthHz; //!< Assumed bandwidth [Hz] for timing check
    double m_puelloPreambleSymbols;    //!< Assumed number of preamble symbols
    Ptr<UniformRandomVariable> m_rng;  //!< RNG for probabilistic capture
    Stats m_stats;
    static bool g_enableProbCaptureDefault;
    static double g_captureSlopeDefault;
    static double g_captureMinProbDefault;
    static double g_captureMaxProbDefault;
    static InterferenceModel g_interferenceModelDefault;
    static double g_puelloCaptureThresholdDbDefault;
    static double g_puelloAssumedBandwidthHzDefault;
    static double g_puelloPreambleSymbolsDefault;
