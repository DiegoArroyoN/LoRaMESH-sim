...
{
    static TypeId tid =
        TypeId("ns3::loramesh::RoutingDv")
            .SetParent<Object>()
            .AddConstructor<RoutingDv>()
            .AddAttribute("PathHopWeight",
                          "Legacy attribute (deprecated, no-op in pure composite DV mode).",
                          DoubleValue(0.05),
                          MakeDoubleAccessor(&RoutingDv::m_pathHopWeight),
                          MakeDoubleChecker<double>(0.0, 1.0))
            .AddAttribute("LinkWeight",
                          "Legacy attribute (deprecated, no-op in pure composite DV mode).",
                          DoubleValue(0.70),
                          MakeDoubleAccessor(&RoutingDv::m_linkWeight),
                          MakeDoubleChecker<double>(0.0, 1.0))
            .AddAttribute("PathWeight",
                          "Legacy attribute (deprecated, no-op in pure composite DV mode).",
                          DoubleValue(0.25),
                          MakeDoubleAccessor(&RoutingDv::m_pathWeight),
                          MakeDoubleChecker<double>(0.0, 1.0))
            .AddAttribute("AdvertiseAllRoutes",
                          "Advertise all known routes in DV messages (subject to maxRoutes).",
                          BooleanValue(false),
                          MakeBooleanAccessor(&RoutingDv::m_advertiseAllRoutes),
                          MakeBooleanChecker())
            .AddAttribute(
                "AdvertRoutePolicy",
                "Route selection policy for beacon payload truncation: top_score | uniform | cost_weighted.",
                StringValue("top_score"),
                MakeStringAccessor(&RoutingDv::SetAdvertRoutePolicy, &RoutingDv::GetAdvertRoutePolicy),
                MakeStringChecker())
            .AddAttribute("MetricMode",
                          "Route metric mode: composite_score | toa_only.",
                          StringValue("composite_score"),
                          MakeStringAccessor(&RoutingDv::SetMetricMode, &RoutingDv::GetMetricMode),
                          MakeStringChecker())
            .AddAttribute("CostEncoding",
                          "On-air byte encoding for announced metric: score100 | cost255 | score255.",
                          StringValue("cost255"),
                          MakeStringAccessor(&RoutingDv::SetCostEncoding, &RoutingDv::GetCostEncoding),
                          MakeStringChecker())
            .AddAttribute("CompositeWToa",
                          "Weight applied to additive ToA path units in composite_score mode.",
                          DoubleValue(1.0),
                          MakeDoubleAccessor(&RoutingDv::m_compositeWToa),
                          MakeDoubleChecker<double>(0.0))
            .AddAttribute("CompositeWHop",
                          "Weight applied to path hop count in composite_score mode.",
                          DoubleValue(1.0),
                          MakeDoubleAccessor(&RoutingDv::m_compositeWHop),
                          MakeDoubleChecker<double>(0.0))
            .AddAttribute("CompositeWEnergy",
                          "Weight applied to energy penalty in composite_score mode.",
                          DoubleValue(2.0),
                          MakeDoubleAccessor(&RoutingDv::m_compositeWEnergy),
                          MakeDoubleChecker<double>(0.0))
            .AddAttribute("CompositeCostStep",
                          "Scalar step used to quantize composite raw cost into a single byte.",
                          DoubleValue(1.0),
                          MakeDoubleAccessor(&RoutingDv::m_compositeCostStep),
                          MakeDoubleChecker<double>(1e-9))
            .AddAttribute("EnergyLo",
                          "Lower energy threshold for composite energy penalty.",
                          DoubleValue(0.20),
                          MakeDoubleAccessor(&RoutingDv::m_energyLo),
                          MakeDoubleChecker<double>(0.0, 1.0))
            .AddAttribute("EnergyHi",
                          "Upper energy threshold for composite energy penalty.",
                          DoubleValue(0.50),
                          MakeDoubleAccessor(&RoutingDv::m_energyHi),
                          MakeDoubleChecker<double>(0.0, 1.0))
            .AddAttribute("EnergyPow",
                          "Exponent used in the composite energy penalty curve.",
                          DoubleValue(3.0),
                          MakeDoubleAccessor(&RoutingDv::m_energyPow),
                          MakeDoubleChecker<double>(0.0))
            .AddAttribute("EnergyMaxPenalty",
                          "Maximum raw-cost penalty applied when energy falls below EnergyLo.",
                          DoubleValue(50.0),
                          MakeDoubleAccessor(&RoutingDv::m_energyMaxPenalty),
                          MakeDoubleChecker<double>(0.0))
            .AddAttribute("MaxRoutesPerDestination",
                          "Maximum number of route candidates stored per destination.",
                          UintegerValue(1),
                          MakeUintegerAccessor(&RoutingDv::SetMaxRoutesPerDestination),
                          MakeUintegerChecker<uint32_t>(1, 2))
            .AddAttribute("MaxTotalRoutes",
                          "Maximum number of route entries across the whole table.",
                          UintegerValue(1024),
                          MakeUintegerAccessor(&RoutingDv::SetMaxTotalRoutes),
            ...
            .AddAttribute("ActiveTimeoutFactor",
                          ...
                          DoubleValue(2.0),
                          MakeDoubleAccessor(&RoutingDv::m_activeTimeoutFactor),
            ...
            .AddAttribute("ActiveDestWindow",
                          ...
                          MakeTimeAccessor(&RoutingDv::m_activeDestWindow),
                          MakeTimeChecker())
            .AddAttribute("PueyoValidationTrace",
                          "Emit detailed validation traces for Pueyo beacon-path auditing.",
                          BooleanValue(false),
                          MakeBooleanAccessor(&RoutingDv::m_pueyoValidationTrace),
                          MakeBooleanChecker());
    return tid;
}
...
void
RoutingDv::SetRouteSwitchMinDeltaX100(uint16_t deltaX100)
{
...
void
RoutingDv::SetAdvertiseAllRoutes(bool enable)
{
    m_advertiseAllRoutes = enable;
}

bool
RoutingDv::GetAdvertiseAllRoutes() const
{
    return m_advertiseAllRoutes;
}

void
RoutingDv::SetAdvertRoutePolicy(const std::string& policy)
{
...
std::string
RoutingDv::GetAdvertRoutePolicy() const
{
...
void
RoutingDv::SetMetricMode(const std::string& mode)
{
...
std::string
RoutingDv::GetMetricMode() const
{
    return (m_metricMode == MetricMode::TOA_ONLY) ? "toa_only" : "composite_score";
}

void
RoutingDv::SetCostEncoding(const std::string& mode)
{
    std::string normalized = mode;
    std::transform(normalized.begin(), normalized.end(), normalized.begin(), [](char ch) {
        return static_cast<char>(std::tolower(static_cast<unsigned char>(ch)));
...
std::string
RoutingDv::GetCostEncoding() const
{
...
void
RoutingDv::SetMaxRoutesPerDestination(uint32_t maxRoutesPerDestination)
{
...
void
RoutingDv::SetMaxTotalRoutes(uint32_t maxTotalRoutes)
{
...
void
RoutingDv::SetSinkNodeId(NodeId id)
{
    m_sinkNodeId = id;
    m_hasSink = true;
}
...
void
RoutingDv::NotifyDestinationActive(NodeId dest)
{
...
bool
RoutingDv::IsDestinationActive(NodeId dest) const
{
...
bool
RoutingDv::IsRouteUsable(const RouteEntry& entry, uint8_t hopLimit) const
{
...
const RouteEntry*
RoutingDv::GetRoute(NodeId dest)
{
...
std::size_t
RoutingDv::GetPrimaryRouteCount() const
{
    return m_routes.size();
}

std::size_t
RoutingDv::GetBackupRouteCount() const
{
    return m_backupRoutes.size();
}

std::size_t
RoutingDv::GetDestinationsWithBackupCount() const
{
    return m_backupRoutes.size();
}

uint64_t
RoutingDv::GetRouteEvictionsTotal() const
{
    return m_routeEvictionsTotal;
}

uint64_t
RoutingDv::GetBackupPromotionsTotal() const
{
    return m_backupPromotionsTotal;
}

std::vector<RouteEntry>
RoutingDv::GetPrimaryRoutesSnapshot() const
{
...
std::vector<RouteEntry>
RoutingDv::GetBackupRoutesSnapshot() const
{
    std::vector<RouteEntry> out;
...
Time
RoutingDv::GetEffectiveTimeout(const RouteEntry& entry) const
{
...
bool
RoutingDv::IsInHoldDown(NodeId dest) const
{
...
void
RoutingDv::SetHoldDown(NodeId dest)
{
    m_holdDownUntil[dest] = Simulator::Now() + m_holdDownTime;
}

void
RoutingDv::CleanExpiredHoldDowns()
{
...
void
RoutingDv::SetLocalEnergyFractionCallback(LocalEnergyFractionCallback cb)
{
    m_localEnergyFractionCallback = cb;
}

bool
RoutingDv::HasRoute(NodeId dest)
{
...
NodeId
RoutingDv::LookupNextHop(NodeId dest)
{
    const RouteEntry* route = GetRoute(dest);
...
double
RoutingDv::GetRouteCost(NodeId dest)
{
    const RouteEntry* route = GetRoute(dest);
    if (!route)
    {
...
double
RoutingDv::GetComparableMetric(const RouteEntry& entry) const
{
...
double
RoutingDv::GetLocalEnergyFraction() const
{
...
double
RoutingDv::ComputeCompositeEnergyPenalty(double energyFraction) const
{
...
double
RoutingDv::ComputeCompositeLinkIncrement(uint8_t sf) const
{
    return m_compositeWToa * static_cast<double>(ToaHopCostUnits(sf)) + m_compositeWHop;
}

double
RoutingDv::ComputeCompositeRawCost(uint32_t toaUnitsPath,
                                   uint8_t hopsPath,
                                   double energyFractionAdvertiser) const
{
    const double toaCost = m_compositeWToa * static_cast<double>(toaUnitsPath);
    const double hopCost = m_compositeWHop * static_cast<double>(hopsPath);
    return toaCost + hopCost + ComputeCompositeEnergyPenalty(energyFractionAdvertiser);
}

uint32_t
RoutingDv::QuantizeCompositeMetric(double rawMetric) const
{
...
uint16_t
RoutingDv::EncodeCompositeMetric(double rawMetric) const
{
...
double
RoutingDv::DecodeCompositeMetric(uint16_t metric) const
{
    if (metric == 0)
    {
...
uint16_t
RoutingDv::CombineScores(uint16_t linkScoreX100, uint16_t pathScoreX100, uint8_t hops) const
{
    const double combinedCost = CombineCost(linkScoreX100, pathScoreX100, hops);
    const double combinedScore = std::clamp(1.0 - combinedCost, 0.0, 1.0);
    return static_cast<uint16_t>(std::round(combinedScore * 100.0));
}

double
RoutingDv::CombineCost(uint16_t linkScoreX100, uint16_t pathScoreX100, uint8_t hops) const
{
    if (m_metricMode == MetricMode::TOA_ONLY)
    {
        const uint32_t linkUnits = std::max<uint16_t>(1, hops);
        const uint32_t pathUnits = ScoreToToaPathUnits(pathScoreX100);
        const uint32_t totalUnits = std::min<uint32_t>(linkUnits + pathUnits, 0xFFFFu);
        return std::clamp(static_cast<double>(ToaUnitsToCostX1000(totalUnits)) / 1000.0, 0.0, 1.0);
    }

    const double localPenalty = ComputeCompositeEnergyPenalty(GetLocalEnergyFraction());
    const double linkRaw = ComputeCompositeLinkIncrement(static_cast<uint8_t>(std::clamp<uint16_t>(hops, 1, 12)));
    const double pathRaw = DecodeCompositeMetric(pathScoreX100);
    if (!std::isfinite(pathRaw))
    {
        return 1.0;
    }
    return linkRaw + pathRaw + localPenalty;
}

uint16_t
RoutingDv::ScoreToCostX1000(uint16_t scoreX100) const
{
...
uint16_t
RoutingDv::ToaHopCostUnits(uint8_t sf) const
{
...
uint16_t
RoutingDv::ScoreToToaPathUnits(uint16_t scoreX100) const
{
    if (scoreX100 == 0)
    {
...
uint16_t
RoutingDv::ToaUnitsToScoreX100(uint32_t units) const
{
...
uint16_t
RoutingDv::ToaUnitsToCostX1000(uint32_t units) const
{
    const uint32_t maxHopUnits = 1u << 5;
    const uint32_t maxPathUnits = std::max<uint32_t>(1u, static_cast<uint32_t>(m_initTtl) * maxHopUnits);
    const double normCost =
...
uint16_t
RoutingDv::MaxAdvertMetricValue() const
{
...
uint16_t
RoutingDv::ToaUnitsToAdvertMetric(uint32_t units) const
{
    if (units == 0)
    {
        return 0;
...
uint16_t
RoutingDv::AdvertMetricToToaPathUnits(uint16_t metric) const
{
    if (metric == 0)
    {
        return std::numeric_limits<uint16_t>::max();
...
bool
RoutingDv::IsCandidateBetter(const RouteEntry& candidate, const RouteEntry& current, bool* tie) const
{
    if (tie)
    {
        *tie = false;
...
bool
RoutingDv::SelectWorseRouteToEvict(NodeId* outDest, bool* outBackup) const
{
...
void
RoutingDv::EnforceRouteTableLimits()
{
...
RoutingDv::UpdateFromDvMsg(const DvMessage& msg, const NeighborLinkInfo& link)
{
    ...
    {
        NS_LOG_UNCOND("DVTRACE_RX_DROP reason=old_seq node=" << m_nodeId << " origin=" << msg.origin
                                                             << " seq=" << msg.sequence
                                                             << " last=" << itSeq->second);
    ...
    else
    {
        const uint32_t units = ToaHopCostUnits(linkSf);
        direct.toaCostUnits = units;
        direct.rawMetric = ComputeCompositeRawCost(units, direct.hops, localEnergyFraction);
    ...
    {
        NS_LOG_UNCOND("PUEYO_VAL_INBOUND node=" << m_nodeId << " origin=" << msg.origin
    ...
    for (size_t i = 0; i < maxToProcess; ++i)
    {
        ...
        if (m_pueyoValidationTrace)
        {
            NS_LOG_UNCOND("PUEYO_VAL_UPDATE_INPUT node=" << m_nodeId << " origin=" << msg.origin
            ...
            else
            {
                ...
                else
                {
                    const double rawMetric =
                        pathRaw + ComputeCompositeLinkIncrement(linkSf) +
                        ComputeCompositeEnergyPenalty(localEnergyFraction);
                    candidate.toaCostUnits = 0;
        ...
        if (m_pueyoValidationTrace)
        {
            NS_LOG_UNCOND("PUEYO_VAL_UPDATE_CAND node=" << m_nodeId << " origin=" << msg.origin
...
void
RoutingDv::DebugDumpRoutingTable() const
{
    NS_LOG_UNCOND("DV_TABLE node" << m_nodeId << ":");
    if (m_routes.empty() && m_backupRoutes.empty())
    {
        NS_LOG_UNCOND("  (vacía)");
        return;
    ...
    {
        const RouteEntry& e = kv.second;
        NS_LOG_UNCOND("  dst=" << e.destination << " nextHop=" << e.nextHop
                               << " hops=" << unsigned(e.hops) << " sf=" << unsigned(e.sf)
                               << " score=" << e.scoreX100 << " seq=" << e.seqNum
                               << " age=" << (Simulator::Now() - e.lastUpdate).GetSeconds() << "s");
    }
    ...
    {
        const RouteEntry& e = kv.second;
        NS_LOG_UNCOND("  [backup] dst=" << e.destination << " nextHop=" << e.nextHop
...
RoutingDv::PrintRouteTo(NodeId dest) const
{
    ...
    NS_LOG_INFO("RoutingDv SNAPSHOT node=" << m_nodeId << " dest=" << dest << " nextHop="
...
std::vector<RouteAnnouncement>
RoutingDv::GetBestRoutesPueyo(uint32_t maxRoutes) const
{
    std::vector<RouteAnnouncement> announcements;
    if (m_pueyoValidationTrace)
    {
        NS_LOG_UNCOND("PUEYO_VAL_GETBEST node=" << m_nodeId << " maxRoutes=" << maxRoutes);
    }
    if (maxRoutes == 0)
    {
        return announcements;
    ...
    for (const auto& kv : m_routes)
    {
        if (m_pueyoValidationTrace)
        {
            ...
            NS_LOG_UNCOND("PUEYO_VAL_ROUTE_POOL node=" << m_nodeId << " source=route"
                                                       << " dest=" << entry.destination
    ...
    for (const auto& kv : m_inboundRoutes)
    {
        ...
        {
            const auto& entry = kv.second;
            NS_LOG_UNCOND("PUEYO_VAL_ROUTE_POOL node=" << m_nodeId << " source=inbound"
                                                       << " dest=" << entry.destination
                                                       << " score=" << entry.scoreX100
                                                       << " sf=" << unsigned(entry.sf)
                                                       << " raw=" << entry.rawMetric);
        ...
        for (const auto& entry : pool)
        {
            if (m_pueyoValidationTrace)
            {
                const double metric = (entry.scoreX100 == 0)
                                          ? static_cast<double>(MaxAdvertMetricValue())
                                          : GetComparableMetric(entry);
                NS_LOG_UNCOND("PUEYO_VAL_ROUTE_CHOSEN node=" << m_nodeId << " mode=all_fit"
                                                             << " dest=" << entry.destination
                                                             << " score=" << entry.scoreX100
                                                             << " metric=" << metric);
            }
    ...
    while (!pool.empty() && announcements.size() < maxRoutes)
    {
        ...
        for (const auto& entry : pool)
        {
            ...
            if (m_pueyoValidationTrace)
            {
                NS_LOG_UNCOND("PUEYO_VAL_ROUTE_WEIGHT node=" << m_nodeId << " dest="
        ...
        if (m_pueyoValidationTrace)
        {
            ...
            NS_LOG_UNCOND("PUEYO_VAL_ROUTE_CHOSEN node=" << m_nodeId << " mode=weighted"
