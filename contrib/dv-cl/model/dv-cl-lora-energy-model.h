...
class DvClLoraEnergyModel : public energy::DeviceEnergyModel
{
  public:
    ...
    void SetAutoTxCurrentFromPower(bool enable);
    bool GetAutoTxCurrentFromPower() const;
    void SetTxCurrentAt14dBmA(double currentA);
    double GetTxCurrentAt14dBmA() const;
    void SetTxCurrentAt20dBmA(double currentA);
    double GetTxCurrentAt20dBmA() const;
    void SetTxPowerDbm(double txPowerDbm);
    double GetLastTxPowerDbm() const;
    static double EstimateTxCurrentA(double txPowerDbm,
                                     double txCurrentAt14dBmA = 0.100,
                                     double txCurrentAt20dBmA = 0.120);
